...
$query = "SELECT c.*, cc.course_category_name 
          ...
          WHERE ec.employee_id = ? AND cc.course_category_id = 5";
...
$query1 = "SELECT COUNT(*) AS total_courses 
           FROM employee_courses ec
           INNER JOIN course c ON ec.course_id = c.course_id
           WHERE ec.employee_id = ? AND c.course_category_id = 5";
      ...
      <main class="main-content">
        <div class="container-fluid">
          ...
          <div class="card mb-3 p-2">
            ...
            <div class="card-body">
              <p class="card-text">
                This comprehensive course provides essential knowledge about money laundering prevention
                in the banking
                sector. You'll learn to identify suspicious activities, understand regulatory
                requirements, and master
                proper reporting procedures. The course combines theoretical knowledge with practical
                case studies to
                ensure you're well-equipped to protect our institution and comply with all relevant
                regulations.
              </p>
