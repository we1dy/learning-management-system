    ...
    <div class="col-md-4 mb-3">
      <div class="card course-card">
        <div class="course-image">
                        <img 
                          src="<?php echo htmlspecialchars($row['course_image'] ?? 'images/placeholder.jpg'); ?>"
                          alt="<?php echo htmlspecialchars($row['course_name']); ?>" style="width: 100%; height: 150px; object-fit: cover;">
                  ...
                  <br>
                  <a href="view_course.php?course_id=<?= $row['course_id'] ?>" class="btn btn-primary">Go to Course</a>
                  </div>
                  </div>
              </div>
            <?php endwhile; ?>
