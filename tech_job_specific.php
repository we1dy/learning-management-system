...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            <!-- Technical/Job-Specific Systems Content -->
            <div id="technical-content" class="content-section">
                <div class="course-header">TECHNICAL/JOB-SPECIFIC SYSTEMS</div>
                    <div class="course-grid">
                        <div class="course-card">
                            <div class="course-image"
                                style="background-image: url('https://via.placeholder.com/300x120?text=Technical+1')"></div>
                            <h3>Core Banking System</h3>
                            <p>Mastering our primary banking platform</p>
                        </div>
                        <div class="course-card">
                            <div class="course-image"
                                style="background-image: url('https://via.placeholder.com/300x120?text=Technical+2')"></div>
                            <h3>Loan Processing</h3>
                            <p>End-to-end loan application workflow</p>
                        </div>
                        <div class="course-card">
                            <div class="course-image"
                                style="background-image: url('https://via.placeholder.com/300x120?text=Technical+3')"></div>
                            <h3>CRM System</h3>
                            <p>Customer relationship management tools</p>
                        </div>
                        <div class="course-card">
                            <div class="course-image"
                                style="background-image: url('https://via.placeholder.com/300x120?text=Technical+4')"></div>
                            <h3>Fraud Detection Systems</h3>
                            <p>Using technology to identify fraud</p>
                        </div>
                        <div class="course-card">
                            <div class="course-image"
                                style="background-image: url('https://via.placeholder.com/300x120?text=Technical+5')"></div>
                            <h3>Data Analytics Tools</h3>
                            <p>Business intelligence for banking</p>
                        </div>
                        <div class="course-card">
                            <div class="course-image"
                                style="background-image: url('https://via.placeholder.com/300x120?text=Technical+6')"></div>
                            <h3>Compliance Reporting</h3>
                            <p>Automated regulatory reporting systems</p>
                        </div>
                    </div>
