...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2025 at 06:59 PM
...
(12, 1, 'Financial Consumer Protection', 'asfasdasd', '../assets/images/courses/1749457605_consumer.jpg'),
(13, 2, 'Core Values', 'Understanding our corporate values.', '../assets/images/courses/1749460875_core.jpg'),
(14, 5, 'Core Banking System', 'Mastering our primary banking platform', '../assets/images/courses/1749465160_banking.jpg');
...
(1, 6, 'sample module/ppt', 'dsadasda', '../assets/modules/sample.pdf'),
(4, 1, 'samplee ppt (replaced)1', NULL, '../assets/modules/samplee ppt (replaced)1684a8ad33353a_.pptx'),
(5, 1, 'samplee pdf', NULL, '../assets/modules/684a87ef05efb_FOR-GURLS.pdf'),
(6, 1, 'dasdasd', 'dasdasd', '../assets/modules/684bbfb30abb2_FOR-GURLS.pdf'),
(14, 1, 'ewqewqe', 'ewqew', 'assets/modules/684bc3715971c_famini, denice pbcom.pdf');
...
INSERT INTO `employee` (`employee_id`, `user_id`, `employee_num`, `last_name`, `first_name`, `middle_initial`, `email`, `birthdate`, `group_id`, `segment_id`, `division_id`, `profile_image`) VALUES
(1, 1, '1', 'sample', 'sampleee', 'a', 'sampleemail@gmail.com', '2008-03-19', 2, 1, 1, '/assets/images/employees/sample.png'),
(2, 4, '2', 'famini', 'denice', 'a', 'faminidenice@gmail.com', '2005-06-17', 1, 1, 2, NULL),
(4, 9, '3', 'min', 'yoonice', 'a', 'minyoonice93@gmail.com', '2002-10-16', 1, 1, 2, NULL),
(5, 10, 'EMP0001', 'famini', 'matrix', 'a', 'johnmatrixfamini@gmail.com', '2003-03-10', 2, 2, 3, NULL);
...
(6, 1, 12, 'In Progress', '2025-06-09', '2025-06-11', NULL, NULL),
(7, 4, 1, 'Assigned', '2025-06-12', NULL, NULL, NULL),
(8, 5, 1, 'Assigned', '2025-06-12', NULL, NULL, NULL),
(9, 2, 1, 'Assigned', '2025-06-13', NULL, NULL, NULL);
...
(1, 'sample', '$2a$12$GoCe8ONZjHyG8rawqBbLquVP9je954PBjkHRAhTq8ZrkbU.REh8ZW', 3, 'Active'),
(4, 'famini', 'famini', 3, 'Active'),
(5, 'head', '$2a$12$sl200pvdyXtLUa7pTb5IB.YjluhHLYIO5PImLxD8vZ06w7NUZ9Lam', 2, 'Active'),
(6, 'yoonice', '$2y$10$.EbtmJ2RegVUPyJq.eF/7eEMGfh3lsencKubTSSGPq619eli109SS', 3, 'Active'),
(9, 'yoonice', '$2y$10$PQMMrrxCiVWjVimDYRTatuRfgBSQTuOMtkN87E7KH65tKL6lLEmmG', 3, 'Active'),
(10, 'matrixx', '$2y$10$aA6J2.JmpRItDlgoCM8OC.bKo2R0ydCgi7eTRHP7orZm4gAZI7lEm', 3, 'Active');
...
(1, 'sample', '2025-06-02 14:40:16', NULL, 1),
(2, 'sample', '2025-06-16 14:44:42', NULL, 1),
(3, 'matrixx', '2025-06-16 14:57:53', NULL, 10);
...
ALTER TABLE `employee`
  ...
  ADD KEY `fk_employee_group_id` (`group_id`),
  ADD KEY `fk_employee_segment_id` (`segment_id`),
  ADD KEY `fk_employee_division_id` (`division_id`);
...
--
ALTER TABLE `segment`
  MODIFY `segment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `employee`
  ...
  ADD CONSTRAINT `fk_employee_division_id` FOREIGN KEY (`division_id`) REFERENCES `division` (`division_id`),
  ADD CONSTRAINT `fk_employee_group_id` FOREIGN KEY (`group_id`) REFERENCES `group` (`group_id`),
  ADD CONSTRAINT `fk_employee_segment_id` FOREIGN KEY (`segment_id`) REFERENCES `segment` (`segment_id`);
